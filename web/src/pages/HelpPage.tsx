        ...
        blocks: [
          {
            ...
            rows: [
              ...
              ["文案", "生成并编辑结构化文案：可是一段自由正文，也可以是文案块或布局分区；标题、卖点、海报标题和 CTA 只是兼容派生字段。"],
    ...
    sections: [
      {
        ...
        blocks: [
          ...
          },
          {
            type: "callout",
            title: "文案不再强制四个字段",
            text: "文案节点保存 CopyPayloadV2。模型可以按场景输出自由正文、短标签块、视觉建议或布局说明；旧的标题、卖点、海报标题和 CTA 会从结构化文案中派生，供旧渲染入口兼容使用。",
          },
        ],
      },
      {
